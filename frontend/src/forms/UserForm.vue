<template>
  <form>
    ...
    <div>
      ...
      <template v-else>
        <button type="submit">Add {{ user.email }}</button>
...
<script>
export default {
  props: ["user", "formMethod", "edit", "cancel"]
};
</script>
